						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									...
									<div class="button5">
    <div class="dropdown">
	<a class="btn btn-primary pz-3 py-2" href="{{ route('cash.payment', ['user_id' => auth()->user()->id, 'total_amount' => $total_amount]) }}">Checkout</a>
	<!-- <div class="dropdown-menu" aria-labelledby="checkoutDropdown">
            <a class="dropdown-item"">Payment Gateway</a>
            <a class="dropdown-item" href="{{route('checkout')}}">Cash ont Delvary</a>
        </div> -->
    </div>
