...
// User section start
    ...
    // SSLCOMMERZ Start
    Route::get('/cash/payment/{user_id}/{total_amount}', [SslCommerzPaymentController::class, 'exampleEasyCheckout'])->name('cash.payment');
...
//SSLCOMMERZ END
Route::get('/porder',[PorderController::class,'porder']);
